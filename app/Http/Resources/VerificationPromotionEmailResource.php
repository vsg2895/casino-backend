...
class VerificationPromotionEmailResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'intro_text_font_size'        => $this->intro_text_font_size,
            'intro_text_background_color' => $this->intro_text_background_color,
            // Bounds, so the admin's number input takes them from the server.
            'intro_text_min_size'         => VerificationPromotionEmail::INTRO_TEXT_MIN_SIZE,
            'intro_text_max_size'         => VerificationPromotionEmail::INTRO_TEXT_MAX_SIZE,
            'intro_text_default_size'     => VerificationPromotionEmail::INTRO_TEXT_DEFAULT_SIZE,
            'button_text_font_size'       => $this->button_text_font_size,
            'button_text_min_size'        => VerificationPromotionEmail::BUTTON_TEXT_MIN_SIZE,
            'button_text_max_size'        => VerificationPromotionEmail::BUTTON_TEXT_MAX_SIZE,
            'button_text_default_size'    => VerificationPromotionEmail::BUTTON_TEXT_DEFAULT_SIZE,
