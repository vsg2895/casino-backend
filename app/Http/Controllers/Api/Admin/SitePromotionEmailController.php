 ...
 * the saved template through the .env SMTP mailer (config('mail.admin_mailer'))
...
class SitePromotionEmailController extends Controller
{
    ...
    public function sendTest(SendTestSiteEmailRequest $request, Site $site): JsonResponse
    {
        ...
        return $this->sendAdminTestEmail($this->emails->mailForSubscriber($site, $template, $newsletter), $to, $site);
    }
}
